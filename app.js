...
route = _.lowerCase(route)
//console.log(route);
  for (var i = 0; i < posts.length; i++) {
  let postsdata  = posts[i].itembody;
postsdata = _.lowerCase(postsdata)
let postcomment = posts[i].comment;
  ...
  res.render("post",{posttitle: postsdata, postdetail: postcomment});
  ...
  //const posts_data = posts[posts.length-1].itembody

  //const itemdata = [];
  //itemdata.push(posts_data);
